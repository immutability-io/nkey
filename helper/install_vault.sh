...
function grab_plugin {
  ...
  wget --progress=bar:force -O ./$1.zip https://github.com/immutability-io/nkey/releases/download/v$2/nkey_$2_$1_amd64.zip
  wget --progress=bar:force -O ./SHA256SUMS https://github.com/immutability-io/nkey/releases/download/v$2/SHA256SUMS
  wget --progress=bar:force -O ./SHA256SUMS.sig https://github.com/immutability-io/nkey/releases/download/v$2/SHA256SUMS.sig
...
function move_plugin {
  ...
  unzip ./$1.zip
  rm ./$1.zip
  mv ./nkey $HOME/etc/vault.d/vault_plugins/nkey
}
